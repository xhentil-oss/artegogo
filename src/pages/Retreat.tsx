        ...
        <div className="space-y-4 text-zinc-600 [&_strong]:text-violet-600" style={{ fontSize: 16, lineHeight: 1.85 }}>
          {lang === "al" ? (
            <>
              ...
              <p>Nuk do keni asnjë përgjegjësi, as pastrim, as gatim – çdo gjë është <strong>gati për ju</strong>.</p>
              ...
              <p>Në sallën e konferencave do organizohen <strong>meditimet dhe seminaret</strong>.</p>
              <p>Do përjetojmë bashkë meditime të thella ku do zhvillojmë një botë të re, një univers dhe një krijim brënda trupit tonë.</p>
        ...
        <div className="space-y-0">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-start gap-3 w-full">
              ...
              <p style={{ fontSize: 16, lineHeight: 1.75, color: "#3f3f46" }}>
                ...
                {t("Matjet e valeve të trurit gjatë meditimit me elektroencefalograme. Mund të zbulojmë se si ka ndikuar meditimi në sistemin nervor. Dhe matje të ", "Brain wave measurements during meditation with electroencephalograms. We can discover how meditation has affected the nervous system. And measurements of ")}<strong style={{ color: "#7C3AED" }}>{t("koherencës së zemrës.", "heart coherence.")}</strong>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 w-full mt-2 mb-6">
            ...
            <p style={{ fontSize: 16, lineHeight: 1.75, color: "#3f3f46", margin: 0 }}>
              {t("Gjithashtu disa persona do përzgjidhen me short për të bërë matjet e qëndrave të energjisë ", "Additionally, a few people will be selected by lottery to have their energy center measurements done ")}<strong style={{ color: "#7C3AED" }}>{t("2 herë", "2 times")}</strong>{t(" (në fillim dhe në fund të retreatit)", " (at the beginning and end of the retreat)")}
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          {(() => {
            const allItems = lang === "al" ? [
              { n: 1, body: <><strong>Mundësia për tu liruar nga emocionet e ulëta, ankthi dhe stres.</strong> Jeta jonë është bërë shumë kërkuese dhe e ulëta, ankthi dhe stres e bën të thjeshtë të humbësh fokusin, të duash të kontrollosh çdo gjë duke kaluar <strong>në stres.</strong> Izolimi për një javë do të të mundësojë një hapësirë ku të <strong>marrësh frymë sërish.</strong></> },
              { n: 2, body: <><strong>Disiplinë mendore.</strong> Nuk ka rëndësi në qoftë se je i avancuar apo fillestar, praktikat e meditimeve do të të ndihmojnë <strong>të disiplinosh mendjen dhe të jesh më i organizuar.</strong></> },
              ...
              { n: 4, body: <><strong>Ndjenja të larta emocionale.</strong> Programi do ju mundësojë që në çdo kohë të jeni në gjendje të lartë emocionale dhe të përjetoni emocione si dashuria, ndjenja e plotësimit, falenderimi, <strong>paqe dhe harmoni në trup dhe në zemër.</strong></> },
              ...
              { n: 7, body: <><strong>Çasti i tanishëm.</strong> Të lidhemi me momentin, me jetën çdo po ndodh tani, të ndiejm diellin, ajrin, ujin, të ndiejm vetë mrekullitë e jetës që po ndodhin <strong>pikërisht tani.</strong></> },
              ...
              { n: 9, body: <><strong>Përshpejtim i zhvillimit personal.</strong> Në një javë do kesh mundur të bësh punën e një viti të zhvillimit personal. <strong>Zhvillimi i lartë i ndërgjegjës</strong> mbi gjendjet emocionale dhe fizike.</> },
            ...
            {[
              {
                ...
                text: lang === "al"
                  ? <>Ne mënyrë që të vini sa më të përgatitur nga ana teorike dhe praktike në retreat, ne do zhvillojmë së bashku <strong>2 seanca përgatitore online</strong> para zhvillimit të retreatit. Qëllimi i këtyre seancave do të jetë që t'ju informojmë paraprakisht për rëndësinë shkenore të metodave që do të përdorim në retreat dhe gjithashtu që t'ju japim praktike se si t'i zbatoni këto njohuri.</>
