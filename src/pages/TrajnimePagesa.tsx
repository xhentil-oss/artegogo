...
const PayForm = () => {
  ...
  const type     = params.get('type')    ?? 'training'; // 'training' | 'workshop'
  ...
  const productTitle = type === 'workshop'
    ? t('Workshop', 'Workshop')
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sticky top-24 space-y-3">
...
export const TrajnimePagesaPage = () => (
