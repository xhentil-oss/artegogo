...
import { User, Mail, Phone, Globe, MapPin, CreditCard, Lock, Lightbulb, Zap, Users, Star, ChevronRight, MessageCircle, Shield, X, CheckCircle, Headphones, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('/api/registrations', {
        ...
        body: JSON.stringify({ firstName, lastName, email, phone, whatsapp, country, city, password, productType: 'workshop' }),
      });
      if (!res.ok) {
