...
import { User, Mail, Phone, Globe, MapPin, CreditCard, Lock, Lightbulb, Zap, Users, Star, ChevronRight, MessageCircle, Shield, X, CheckCircle, Headphones } from 'lucide-react';
...
export const RegjistrohuWorkshopPage = () => {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen pb-12" style={{ backgroundColor: '#f8f7ff' }}>
      ...
      <div className="text-center pt-10 pb-6 px-4">
        ...
        <h1 className="hero-title-mobile font-bold leading-tight mb-2" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 'clamp(1.8rem, 5vw, 2.8rem)', color: '#1a1a2e' }}>
          ...
          <span style={{ color: '#7c3aed', fontStyle: 'italic' }}>{t("Workshop", "Workshop")}</span>
        </h1>
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer select-none">
              ...
              <span className="text-xs text-zinc-600 leading-relaxed">
                {t("Duke plotësuar këtë formular, konfirmoj se të dhënat e mia janë të sakta dhe dëshiroj të regjistrohem për workshopin.", "By completing this form, I confirm that my details are accurate and I wish to register for the workshop.")}
              </span>
            </label>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
              ...
              <div className="p-5">
                ...
                <div className="space-y-4 mb-5">
                  {[
                    { Icon: Lightbulb, title: t("Njohuri praktike", "Practical knowledge"),         desc: t("Mëso teknika të zbatueshme menjëherë në jetën tënde të përditshme.", "Learn techniques immediately applicable in your daily life.") },
                    { Icon: Zap,       title: t("Energji dhe motivim", "Energy and motivation"),     desc: t("Rikthe energjinë dhe qartësinë e mendjes me ushtrime intensive.", "Restore your energy and mental clarity with intensive exercises.") },
                    { Icon: Users,     title: t("Komunitet i fortë", "Strong community"),             desc: t("Takohu me njerëz me të njëjtat synime dhe ndaj përvojat.", "Meet like-minded people and share experiences.") },
                    { Icon: Star,      title: t("Udhëzim ekspert", "Expert guidance"),               desc: t("Udhëhiqet nga Dr. Marvin Bundo me vite përvojë në zhvillim personal.", "Led by Dr. Marvin Bundo with years of personal development experience.") },
          ...
          <div className="bg-white rounded-3xl shadow-2xl relative overflow-y-auto"
            ...
            <div className="px-7 pt-4 pb-4 text-center">
              ...
              <p className="text-zinc-500 mb-3 max-w-sm mx-auto" style={{ fontSize: 13 }}>
                {t("Zgjidh mënyrën që preferon për të siguruar vendin në workshop.", "Choose how you prefer to secure your spot in the workshop.")}
              </p>
