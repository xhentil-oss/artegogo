...
export const RegjistrohuTrajnimPage = () => {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen pb-12" style={{ backgroundColor: '#f8f7ff' }}>
      ...
      <div className="text-center pt-10 pb-6 px-4">
        ...
        <h1 className="font-bold leading-tight mb-2" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 'clamp(1.8rem, 5vw, 2.8rem)', color: '#1a1a2e' }}>
          ...
          <span style={{ color: '#7c3aed', fontStyle: 'italic' }}>{t("Trajnimin Online", "Online Training")}</span>
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer select-none">
              ...
              <span className="text-xs text-zinc-600 leading-relaxed">
                {t("Duke plotësuar këtë formular, konfirmoj se të dhënat e mia janë të sakta dhe dëshiroj të regjistrohem për trajnimin online.", "By completing this form, I confirm that my details are accurate and I wish to register for the online training.")}
              </span>
            </label>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
              {/* Laptop image with overlay text */}
              <div className="relative">
                <img src="/img/TONI1692.JPG" alt="Trajnim Online" className="w-full h-44 object-cover" />
                <div className="absolute inset-0 flex items-center justify-center" style={{ background: 'rgba(78,41,197,0.55)' }}>
                  <div className="text-center px-4">
                    ...
                    <p className="text-white/80 text-sm">{t("nga çdo vend.", "from anywhere.")}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5">
                ...
                <div className="space-y-4 mb-5">
                  {[
                    ...
                    { Icon: Clock,  title: t("Fleksibilitet i plotë", "Full flexibility"),                    desc: t("Mëso në ritmin tënd, kur dhe ku të dëshirosh.", "Learn at your own pace, whenever and wherever you wish.") },
          ...
          <div className="bg-white rounded-3xl shadow-2xl relative overflow-y-auto" style={{ width: 800, maxWidth: '95vw', maxHeight: '90vh' }}>
            ...
            <div className="px-7 pt-4 pb-4 text-center">
              ...
              <p className="text-zinc-500 mb-3 max-w-sm mx-auto" style={{ fontSize: 13 }}>
                {t("Zgjidh mënyrën që preferon për të siguruar vendin në trajnim online.", "Choose how you prefer to secure your spot in the online training.")}
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                <div className="flex flex-col items-center rounded-2xl p-4 border-2 text-center" style={{ borderColor: '#7c3aed', backgroundColor: '#faf9ff' }}>
                  ...
                  <button
                    onClick={() => { setReserveOpen(false); navigate('/eventet/trajnime-online/pagesa'); }}
