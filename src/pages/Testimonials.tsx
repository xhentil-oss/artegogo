            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-full text-sm font-medium transition-all duration-200${cat.id === "sherim-femije" ? " col-span-2 md:col-span-1 w-fit" : ""}`}
                  style={{
                    padding: "8px 16px",
                    fontSize: 14,
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
              {filtered.map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="h-52 md:h-[420px]" style={{ background: "#f4f4f5", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <img
                        src={item.image}
                        alt={item.label}
