    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FFFFFF" }}>
      <div className="relative overflow-hidden min-h-[320px] md:min-h-[420px] flex items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-20 flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full">
          <div className="flex-1 text-left">
            <h1 className="hero-title-mobile md:hidden font-bold" style={{ fontFamily: "'Playfair Display', Georgia, serif", color: "#ffffff" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          {/* WhatsApp */}
          <a href="https://wa.me/355692420827" target="_blank" rel="noopener noreferrer"
            className="group flex flex-col items-center text-center gap-3 p-5 rounded-2xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-200 hover:-translate-y-0.5" style={{ backgroundColor: "#F9FAFB" }}>
