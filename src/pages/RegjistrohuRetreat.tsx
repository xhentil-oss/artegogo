  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('/api/registrations', {
        ...
        body: JSON.stringify({ firstName, lastName, email, phone, whatsapp, country, city, roomPreference, password, productType: 'retreat' }),
      });
      if (!res.ok) {
      ...
      const dest = `/eventet/retreat/pagesa?${params.toString()}`;
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select value={roomPreference} onChange={e => setRoomPreference(e.target.value)} className="w-full pl-10 pr-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-violet-400 transition-all appearance-none"
