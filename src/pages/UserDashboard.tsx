  ...
  <div className="space-y-6">
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
      ...
      <div className="pt-2 flex flex-col sm:flex-row gap-3">
        ...
        <a href="mailto:info@artegogo.com"
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold border border-gray-200 text-zinc-700 hover:bg-gray-50 transition-all">
          info@artegogo.com
        </a>
      </div>
    </div>
