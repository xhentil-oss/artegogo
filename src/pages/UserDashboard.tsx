  ...
  <div className="space-y-6">
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
      {[
        ...
        { q: t('Kam problem me llogarinë time.', 'I have a problem with my account.'), a: t('Na kontakto në info@artegogo.com ose +355 69 242 0827', 'Contact us at info@artegogo.com or +355 69 242 0827') },
      ].map(({ q, a }, i) => (
      ...
      <div className="pt-2">
        <a href="mailto:info@artegogo.com" className="inline-flex items-center gap-2 text-sm font-semibold text-violet-600 hover:text-violet-800 transition-colors">
          info@artegogo.com →
        </a>
      </div>
    </div>
