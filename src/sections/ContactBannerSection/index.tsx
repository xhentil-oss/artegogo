        ...
        <div className="max-w-4xl mx-auto w-full transition-all duration-700 delay-100"
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            <a href="https://wa.me/355692420827" target="_blank" rel="noopener noreferrer"
              className="group flex items-center gap-2 md:gap-4 p-3 md:p-5 rounded-2xl border border-zinc-300 hover:opacity-90 transition-all duration-200 hover:-translate-y-0.5" style={{ background: "#F9FAFB" }}>
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>WhatsApp</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Për pyetje dhe informacione:", "For questions and information:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>+355 69 242 0827</p>
              </div>
            </a>
            ...
            <a href="https://instagram.com/arte_gogo" target="_blank" rel="noopener noreferrer"
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>Instagram</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Na ndiqni dhe na shkruani direkt:", "Follow us and write to us directly:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>@arte_gogo</p>
              </div>
            </a>
            ...
            <a href="https://www.facebook.com/profile.php?id=100070180624280" target="_blank" rel="noopener noreferrer"
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>Facebook</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Na ndiqni:", "Follow us:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>Arte Gogo — Facebook</p>
              </div>
            </a>
            ...
            <a href="https://youtube.com/@artegogo3246?si=mh18TVeVBhO5sAUO" target="_blank" rel="noopener noreferrer"
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>YouTube</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Na ndiqni:", "Follow us:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>@artegogo3246</p>
              </div>
            </a>

            <a href="mailto:info@artogogo.com"
              className="group flex items-center gap-2 md:gap-4 p-3 md:p-5 rounded-2xl hover:opacity-90 transition-all duration-200 hover:-translate-y-0.5"
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>Email</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Na shkruani:", "Write to us:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>info@artogogo.com</p>
              </div>
            </a>
            ...
            <a href="https://tiktok.com/@dr.artegogo" target="_blank" rel="noopener noreferrer"
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-base leading-relaxed font-bold mb-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>TikTok</p>
                <p className="text-xs md:text-base leading-relaxed" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>{t("Na ndiqni:", "Follow us:")}</p>
                <p className="text-xs md:text-base leading-relaxed font-semibold mt-0.5" style={{ color: "#52525b", fontFamily: "'Inter', sans-serif" }}>@dr.artegogo</p>
              </div>
            </a>
          </div>
